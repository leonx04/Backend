...
@RestController
@RequestMapping("api/${api.version}/admin/colors")
...
public class ColorController {
    ...
    public ResponseData<?> getDataPage(
        ...
        return new ResponseData<>(HttpStatus.OK.value(), "Retrieved data successfully", this.colorService.getPageData(attributeParamRequest));
    }
